...
class AutoTimerSettings(Screen, ConfigListScreen):
	...
	def __init__(self, session):
		...
		self.list = [
			...
			getConfigListEntry(_("Style auto timers list"), config.plugins.autotimer.style_autotimerslist, _("If the style is advanced, you will see more information about each auto timer. Change needs plugin restart.")),
